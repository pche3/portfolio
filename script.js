$(document).ready( function() {
  ...
  $("#project2").on("click", function() {
    ...
    $("#context").html("This website is dedicated to a project that me and friends worked on. Also, it is the first website I made to pratice front-end development. The project is all about developing a new product that eliminates previous challenges analog theremin faces.");
    });
})